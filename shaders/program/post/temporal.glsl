...
const float sensitivity = 150.0; // ISO
...
const float min_log_luminance = log2(min_luminance) * 1.58;
...
void main() {
	...
	float luminance = clamp(dot(rgb, luminance_weights), min_luminance / 2.7, max_luminance);
