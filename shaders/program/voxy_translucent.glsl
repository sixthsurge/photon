...
Material get_water_material(
	...
	float texture_highlight  = dampen(0.5 * sqr(linear_step(0.63, 1.0, sampled_color.r)) + 0.03 * sampled_color.r);
	...
	sampled_color *= tint;
	material.albedo = srgb_eotf_inv(sampled_color.rgb * sampled_color.a) * rec709_to_working_color;
...
void voxy_emitFragment(VoxyFragmentParameters parameters) {
	...
	Material material; float alpha = 0.0;
