...
const vec3[32] light_color = vec3[32](
	vec3(WHITE_LIGHT_R * 1.00, WHITE_LIGHT_G * 1.00, WHITE_LIGHT_B * 1.00) * WHITE_LIGHT * 12.0, // Strong white light
	vec3(WHITE_LIGHT_R * 1.00, WHITE_LIGHT_G * 1.00, WHITE_LIGHT_B * 1.00) * WHITE_LIGHT * 6.0, // Medium white light
	vec3(WHITE_LIGHT_R * 1.00, WHITE_LIGHT_G * 1.00, WHITE_LIGHT_B * 1.00) * WHITE_LIGHT * 1.0, // Weak white light
	vec3(GOLDEN_LIGHT_R * 1.00, GOLDEN_LIGHT_G * 0.55, GOLDEN_LIGHT_B * 0.27) * GOLDEN_LIGHT * 14.0, // Strong golden light
	vec3(GOLDEN_LIGHT_R * 1.00, GOLDEN_LIGHT_G * 0.55, GOLDEN_LIGHT_B * 0.27) * GOLDEN_LIGHT * 8.0, // Medium golden light
	vec3(GOLDEN_LIGHT_R * 1.00, GOLDEN_LIGHT_G * 0.55, GOLDEN_LIGHT_B * 0.27) * GOLDEN_LIGHT * 6.0, // Weak golden light
	...
	vec3(SOUL_LIGHT_R * 0.45, SOUL_LIGHT_G * 0.73, SOUL_LIGHT_B * 1.00) * SOUL_LIGHT * 6.0, // Soul lights
	...
	vec3(CANDLE_LIGHT_R * 1.00, CANDLE_LIGHT_G * 0.57, CANDLE_LIGHT_B * 0.30) * CANDLE_LIGHT * 8.0, // Medium golden light
