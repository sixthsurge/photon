...
// Photonics shorthand, 'PHOTONICS' is always defined by Photonics when it's installed
#if defined PHOTONICS && defined PHO_ENABLED
#define PHO_IN_USE
#endif
...
vec3 transform(mat4 m, vec3 pos) { return mat3(m) * pos + m[3].xyz; }
