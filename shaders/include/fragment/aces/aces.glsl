...
const float rrtRedScale  = 0.95 * RRT_RED_SCALE;  // default: 0.82
...
const float rrtSatFactor = 0.93 * RRT_SAT_FACTOR; // default: 0.96
const float odtSatFactor = 0.97 * ODT_SAT_FACTOR; // default: 0.93
